...
class TrackPlayer {
   ...
   * @returns Index of the current track, or `null` if none
   */
  public static getCurrentTrack(): number | null {
    const instance = TrackPlayer.getInstance()
    return instance.currentTrackIndex >= 0 ? instance.currentTrackIndex : null
  }
