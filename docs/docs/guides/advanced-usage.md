...
This guide covers more advanced usage patterns for React Track Player Web to help you create a
fully-featured and robust audio player.
...
import TrackPlayer, { useTrackPlayerEvents, Event, State } from "react-track-player-web"
...
```javascript
import React, { useEffect } from "react"
import TrackPlayer, { Event, State } from "react-track-player-web"
